...
Revision ID: 3fc3173b0c8c
Revises: 
Create Date: 2021-04-09 21:03:35.602935
...
def upgrade():
    ...
    sa.Column('favorite_type', sa.Enum('person', 'planet', 'vehicle', name='entitytypeenum'), nullable=False),
